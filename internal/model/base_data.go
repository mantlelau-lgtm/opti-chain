...
type Material struct {
	BaseModel
	SKUCode  string          `gorm:"column:sku_code;size:64;uniqueIndex;not null" json:"sku_code"`
...
type Supplier struct {
	BaseModel
	SupplierCode  string `gorm:"column:supplier_code;size:64;uniqueIndex;not null" json:"supplier_code"`
	Name          string `gorm:"column:name;size:128;not null" json:"name"`
...
type Warehouse struct {
	BaseModel
	WarehouseCode string `gorm:"column:warehouse_code;size:32;uniqueIndex;not null" json:"warehouse_code"`
...
type Location struct {
	...
	LocationCode string `gorm:"column:location_code;size:32;not null;uniqueIndex" json:"location_code"`
