...
var routePerms = []routePerm{
	...
	{"GET", "/products", "bom:view"}, {"GET", "/products/:id", "bom:view"},
	{"POST", "/products", "bom:edit"}, {"PUT", "/products/:id", "bom:edit"}, {"DELETE", "/products/:id", "bom:edit"},
	{"GET", "/boms", "bom:view"}, {"GET", "/boms/:id", "bom:view"}, {"GET", "/boms/product/:pid", "bom:view"},
	{"POST", "/boms", "bom:edit"}, {"PUT", "/boms/:id", "bom:edit"}, {"DELETE", "/boms/:id", "bom:edit"},
	...
	{"GET", "/approval-groups", "approval:manage"},
	{"POST", "/approval-groups", "approval:manage"},
	{"PUT", "/approval-groups/:id", "approval:manage"},
	{"DELETE", "/approval-groups/:id", "approval:manage"},
	{"GET", "/supplier-material", "supplier:view"},
	{"POST", "/supplier-material", "supplier:manage"},
	{"PUT", "/supplier-material/:id", "supplier:manage"},
	{"DELETE", "/supplier-material/:id", "supplier:manage"},
